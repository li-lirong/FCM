...
public struct FCM {
    ...
    init(application: Application, client: Client) {
        var httpClientConfiguration = application.http.client.configuration
        if !httpClientConfiguration.ignoreUncleanSSLShutdown {
            httpClientConfiguration.ignoreUncleanSSLShutdown = true
        }
